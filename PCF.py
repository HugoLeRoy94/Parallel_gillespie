...
class PCF:
    ...
    def compute(self,time,move,*args):
        ...
        self.dist_matrix = distance_matrix(self.gillespie.get_r(),self.gillespie.get_r())
    ...
    def end_check_step(self,i,*args):
        self.counts = self.counts / (self.time * self.shell_volumes*self.dist_matrix.shape[0])
